...
We can count the number of recalls for each company by grouping on the `Manufacturer name` column and summarizing the count. We'll only look at manufacturers with recalls counts above 50.
```{r data}
...
There are 10 manufacturers with greater than 50 recalls for products manufactured in 2000.

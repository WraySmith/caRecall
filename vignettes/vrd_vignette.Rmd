...
```{r plot, eval = FALSE, fig.width=7, fig.height=5, fig.align='center', warning=FALSE, message=FALSE}
nb.cols <- 11
...
```{r plot2, eval = FALSE, fig.width=7, fig.height=5, fig.align='center', warnings = FALSE, message = FALSE}
recall_comparison %>%
  ggplot() +
